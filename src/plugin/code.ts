...
async function createDemoMap(model: Model) {
  ...
  const sWest   = model.addStation({ name: 'West Station',    textAlign: 'right',  textHAlign: 'left', textVAlign: 'center', textRotation: 0, flipped: false, interpT: 0.2,  roadSection: sec1 });
  const sCentral = model.addStation({ name: 'Central Station', textAlign: 'bottom', textHAlign: 'left', textVAlign: 'center', textRotation: 0, flipped: false, interpT: 0.5,  roadSection: sec1 });
  const sEast    = model.addStation({ name: 'East Station',   textAlign: 'right',  textHAlign: 'left', textVAlign: 'center', textRotation: 0, flipped: false, interpT: 0.8,  roadSection: sec2 });
  const sNorth   = model.addStation({ name: 'North Station',  textAlign: 'right',  textHAlign: 'left', textVAlign: 'center', textRotation: 0, flipped: false, interpT: 0.7,  roadSection: sec3 });
  const sMid     = model.addStation({ name: 'Midpoint',       textAlign: 'right',  textHAlign: 'left', textVAlign: 'center', textRotation: 0, flipped: false, interpT: 0.5,  roadSection: sec2 });
