...
export type PluginToUIMessage =
  ...
  | { type: 'line-path-data'; lineId: LineId; paths: LinePathData[]; stationNames: Record<StationId, string>; stationRoadIds: Record<StationId, RoadId | null>; stationSectionIds: Record<StationId, RoadSectionId | null> }
