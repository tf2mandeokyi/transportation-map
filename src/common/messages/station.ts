import { HVAlign, LineId, RoadSectionId, StationId, TextHAlign, TextVAlign } from "../types";

export type StationParams = { name: string; textAlign: HVAlign; textHAlign: TextHAlign; textVAlign: TextVAlign; textRotation: number; flipped: boolean };
